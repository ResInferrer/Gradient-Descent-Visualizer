    ...
    def run(self):
        ...
        while True:
            if choice == 0:
                ...
                if problem_type == 0:
                    self.logistic_regression_binary(X_part, X_val, y_part, y_val)
                else:
                    self.logistic_regression_multiclass(X_part, X_val, y_part, y_val)
                ...
                print("-"*40 + "\n")
                self.svm(X_part, X_val, y_part, y_val)
                break
            else:
